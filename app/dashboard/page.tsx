...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    const workflows = storageService.getWorkflowInstancesByOwner(
      currentUser.id
    );
    ...
    const templates = storageService.getAccessibleWorkflowTemplates(
      currentUser.id
    );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Card className="mt-8">
          <CardHeader>
            ...
            <CardDescription>
              Start a new workflow from these templates
            </CardDescription>
          </CardHeader>
          <CardContent>
